...
const ROUTES = [
  ...
  { path: '/co-branding',                page: 'CoBrandingPage',         label: 'Co-branding',    nav: 5 },
  { path: '/notation',                   page: 'NotationPage',           label: 'Writing Style',  nav: 6 },
  { path: '/applications',               page: 'ApplicationsPage',       label: 'Applications',   nav: 7 },
  { path: '/digital',                    page: 'DigitalPage',            label: 'Digital',        nav: 8 },
  { path: '/special-zones',              page: 'SpecialZonesIndex',      label: 'Special Zones',  nav: 9 },
  ...
  { path: '/permissions',                page: 'PermissionsPage',        label: 'Usage Rights',   nav: 10 },
  { path: '/faq',                        page: 'FaqPage',                label: 'FAQ',            nav: 11 },
